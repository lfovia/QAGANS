...
name = './cifar_SSIM_checkpoints'
log_dir = './cifar_SSIM_logs'
...
with tf.name_scope('SSIM_regularizer'):
	...
	"""SSIM_penalty_denominator = tf.where(tf.is_nan(SSIM_penalty_denominator, 1.414*tf.ones_like(SSIM_penalty_denominator), SSIM_penalty_denominator) """
	######################################## the proposed SSIM-GP regularizer  ####################
